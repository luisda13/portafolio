        ...
        {conocimientos.map((item, index) => (
          ...
          <div key={index} className="flex flex-col items-center w-20 group">
            <button
              ...
              className="relative w-14 h-14 flex items-center justify-center bg-white rounded-xl border-2 border-gray-100 shadow-sm overflow-hidden"
            >
              {/* fondo animado */}
